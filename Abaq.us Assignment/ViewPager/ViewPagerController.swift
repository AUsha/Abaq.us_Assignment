...
public class ViewPagerController:UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        tabContainer.layer.zPosition = 15
        
        tabContainer.layer.masksToBounds = false
        tabContainer.layer.shadowOffset = CGSize(width: 0, height: 3)
        tabContainer.layer.shadowOpacity = 0.2
        tabContainer.layer.shadowRadius = 3
    }
    ...
    public func displayViewController(atIndex index:Int) {
        ...
        pageViewController.setViewControllers([chosenViewController], direction: direction, animated: false, completion: { (isCompleted) in
